...
typedef struct
{
	...
	lv_obj_t *ST7789V3_OutputCurrent_Lable;
	lv_obj_t *ST7789V3_CurrentUnit_Lable;
	lv_obj_t *ST7789V3_OutputVlotage_Lable;
	lv_obj_t *ST7789V3_VoltageUnit_Lable;

	lv_obj_t *ST7789V3_SetVolatgeUnit_Lable;
	lv_obj_t *ST7789V3_SetVoltageSpinbox;
	lv_obj_t *ST7789V3_SetCurrentUnit_Lable;
	lv_obj_t *ST7789V3_SetCurrentSpinbox;
...
LV_FONT_DECLARE(lv_font_MonosB_40)
LV_FONT_DECLARE(lv_font_montserratMedium_16)
LV_FONT_DECLARE(lv_font_MonosB_30)
LV_FONT_DECLARE(lv_font_MonosB_16)
LV_FONT_DECLARE(lv_font_MonosB_32)
LV_FONT_DECLARE(lv_font_MonosB_22)
LV_FONT_DECLARE(lv_font_MonosB_18)
