...
const uint8_t  MyCfgDescr[] =
{
    ...
    /* Interrupt upload endpoint descriptor , 0x81 IN */
    0x07, 0x05, CDC_UEP_INT, 0x03, (uint8_t)DEF_USBD_ENDP1_SIZE, (uint8_t)( DEF_USBD_ENDP1_SIZE >> 8 ), 0x01,

    /* Interface 1 (data interface) descriptor */
    0x09, 0x04, 0x01, 0x00, 0x02, 0x0A, 0x00, 0x00, 0x00,

    /* Endpoint descriptor , 0x02 OUT */
    0x07, 0x05, CDC_UEP_OUT, 0x02, (uint8_t)DEF_USBD_ENDP2_SIZE, (uint8_t)( DEF_USBD_ENDP2_SIZE >> 8 ), 0x00,

    /* Endpoint descriptor , 0x83 IN */
    0x07, 0x05,  CDC_UEP_IN, 0x02, (uint8_t)DEF_USBD_ENDP3_SIZE, (uint8_t)( DEF_USBD_ENDP3_SIZE >> 8 ), 0x00,
};
